...
//		public InterfaceContractResolver(Type baseObjectType, Type serializableInterface): base()
//		{
...
//			List<PropertyInfo> interfaceMembers = GetInterfaceProperties(_serializableInterface).Cast<PropertyInfo>().Where(m => !IsIndexedProperty(m)).ToList();
